...
parameters_list = {'datadir';'data_format';'dt';'tdom';'mean_window';'pow_window';'sta_window';...
    'lta_window';'n_iterations';'stop_criteria';'save_fig';'pick_thr'};
...
if ischar(par.pow_window) || mod(par.pow_window,2) ~= 0 || par.pow_window < 2
